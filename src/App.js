...
export default class App extends Component {
  ...
  fetchNearbyRestaurants() {
    ...
    // move to config?
    const fsRestUrl = `https://api.foursquare.com/v2/venues/search?categoryId=4d4b7105d754a06374d81259&ll=${lat},${lng}&client_id=${config.CLIENT_ID}&client_secret=${config.CLIENT_SECRET}&radius=200000000&intent=browse&limit=50&v=20170101`;
